...
RUN echo 'cachebuster 2026-07-08' && apt-get update && apt-get upgrade -y --no-install-recommends --no-install-suggests
...
ARG CHROMIUM_VERSION=150.0.7871.46-1~deb13u1
