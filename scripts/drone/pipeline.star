...
load('scripts/drone/common.star', 'install_deps_step', 'build_step', 'package_step', 'security_scan_step', 'e2e_grafana_setup_step', 'e2e_volumes', 'tests_step')
