...
def secrets():
    return [
        ...
        vault_secret('github_app_id', 'secret/data/ci/repo/grafana/grafana-image-renderer/github-app', 'app-id'),
        vault_secret('github_app_private_key', 'secret/data/ci/repo/grafana/grafana-image-renderer/github-app', 'private-key'),
        vault_secret('github_app_installation_id', 'secret/data/ci/repo/grafana/grafana-image-renderer/github-app', 'app-installation-id'),
